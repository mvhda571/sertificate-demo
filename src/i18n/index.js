...
const resources = {
  uz: { translation: {
    dashboard:'Bosh sahifa', subjects:'Fanlar', tests:'Sinov testlari', flashcards:'Flashcards', graph:'Bilim xaritasi', tutor:'AI Tutor', results:'Natijalarim', leaderboard:'Profil',
    homeSubtitle:'Interaktiv testlar, aqlli tahlil va shaxsiy o‘quv rejasi bilan yuqori sertifikat darajasiga tayyorlaning.',
  }},
  en: { translation: {
    dashboard:'Home', subjects:'Subjects', tests:'Mock exams', flashcards:'Flashcards', graph:'Knowledge map', tutor:'AI Tutor', results:'My results', leaderboard:'Profile',
